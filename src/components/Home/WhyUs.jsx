...
const WhyUs = () => {
  const details=[
              { icon: <ShieldCheck />, 
                title: "100% Genuine Material", 
                desc: "Direct company se - Ultratech, ACC, Tata Tiscon. No duplicate." },
              { icon: <Truck />, 
                title: "Ghar Tak Delivery", 
                desc: "Unnao city mein same day delivery. Site par utarwa ke jaayenge." },
              { icon: <Award />, 
                title: "Sahi Rate Guarantee", 
                desc: "Market se mehenga lage to batao, rate match karenge." },
              { icon: <Users />, 
                title: "Mistri + Material Package", 
                desc: "Ache mistri ka contact bhi dilwate hain - free." 
              }
            ]
